; Fortnite_cityTycoon_servePizza.ahk
; For Fortnite - "City Tycoon"
; Serve pizza automatically
...
; if (ok:=FindText(&X, &Y, 738-150000, 269-150000, 738+150000, 269+150000, 0, 0, Text))
; ; if (ok:=FindText(&X, &Y, 715-150000, 269-150000, 715+150000, 269+150000, 0, 0, Text))
; ; if (ok:=FindText(&X, &Y, 492-150000, 587-150000, 492+150000, 587+150000, 0, 0, Text))
; ; if (ok:=FindText(&X, &Y, 724-150000, 263-150000, 724+150000, 263+150000, 0, 0, Text))
; {
;   ; FindText().Click(X, Y, "L")
; }
